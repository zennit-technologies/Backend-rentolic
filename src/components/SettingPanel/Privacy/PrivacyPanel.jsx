...
import { deletePrivacy, loadPrivacys } from '../../../Actions/privacyAction';
...
const PrivacyPanel = () => {
    ...
    const displayUsers = privacys.filter((data) => {
        if (searchVal === "") {
            return data;
        } else if (
    ...
    const pageCount = Math.ceil(privacys.length / usersPerPage);
            ...
            <div className="col-lg-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h4 className="card-title">Privacy Policy List <small>Dashboard</small></h4>
                        <Link
                            class="action-button badge badge-primary"
                            to="/Admin/privacy-policy/Create">Add Policy</Link>
                        <button className="action-button badge badge-primary">
                            {/* <FontAwesomeIcon icon="download" /> */}
                            <ExportCSV csvData={privacys} fileName={fileName} />
                        </button>
