...
import { deleteSlider, loadSliders } from '../../../Actions/sliderAction';
...
const SliderScreen = () => {
    ...
    const displayUsers = sliders.filter((data) => {
        if (searchVal === "") {
            return data;
        } else if (
        ...
        return (
            <tr>
                ...
                <td>
                    <img src={`${process.env.REACT_APP_IPURL}${state.image}`} alt="ads" />
                </td>
                {/* <td>
                    {state.title}
                </td> */}
    ...
    const pageCount = Math.ceil(sliders.length / usersPerPage);
            ...
            <div className="col-lg-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h4 className="card-title">Slider List <small>Dashboard</small></h4>
                        <Link
                            class="action-button badge badge-primary"
                            to="/slider/create">Add Slider</Link>
                        <button className="action-button badge badge-primary">
                            {/* <FontAwesomeIcon icon="download" /> */}
                            <ExportCSV csvData={sliders} fileName={fileName} />
                        </button>
