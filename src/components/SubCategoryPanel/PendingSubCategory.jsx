...
const PendingSubCategory = () => {
    ...
    const displayUsers = pendingSubCatrorys.filter((data) => {
        if (searchVal === "") {
            return data;
        } else if (
    ...
    finder = pendingSubCatrorys.filter((val) => {
        if (searchVal === "") {
            return val;
        } else if (
    ...
    const pageCount = Math.ceil(pendingSubCatrorys.length / usersPerPage);
            ...
            <div className="col-lg-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h4 className="card-title">Pending Sub Category List <small>Dashboard</small></h4>
...
export default PendingSubCategory