...
const ProductsList = () => {
    ...
    const displayUsers = products.filter((data) => {
        if (searchVal === "") {
            return data;
        } else if (
            data.id == searchVal 
            ...
            <div className="col-lg-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        ...
                        <Link
                            className="action-button badge badge-primary"
                            to="/Product/Create">Add Product</Link>
                        <button className="action-button badge badge-primary">
                            {/* <FontAwesomeIcon icon="download" /> */}
                            <ExportCSV csvData={products} fileName={fileName} />
                        </button>

                        <input type="text" className="search__input form-control border-transparent placeholder-theme-13 col-lg-6 mt-3 mb-3" placeholder="Search Product..." value={searchVal} onChange={(e) => { setSearchVal(e.target.value); }} />
