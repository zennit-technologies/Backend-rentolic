...
import { loadApps } from '../../../Actions/approvedProductAction';
...
const ApprovedProducts = () => {
    ...
    const { apps } = useSelector(state => state.AppData);
    useEffect(() => {
        dispatch(loadApps());
    }, []);
    // LOAD ACTIONS ENDS
    ...
    const displayUsers = apps.filter((data) => {
        if (searchVal === "") {
            return data;
        } else if (
    ...
    const pageCount = Math.ceil(apps.length / usersPerPage);
            ...
            <div className="col-lg-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h4 className="card-title">approved Products <small>Dashboard</small></h4>
                        {/* <Link
                        ...
                        <button className="action-button badge badge-primary">
                            ...
                            <ExportCSV csvData={apps} fileName={fileName} />
                        </button>
