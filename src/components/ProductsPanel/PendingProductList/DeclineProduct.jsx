...
import { loadDeclines } from '../../../Actions/declinesAction';
...
const DeclineProduct = () => {
    ...
    const { declines } = useSelector(state => state.declineProductsData);
    useEffect(() => {
        dispatch(loadDeclines());
    }, []);
    // LOAD ACTIONS ENDS
    ...
    const displayUsers = declines.filter((data) => {
        if (searchVal === "") {
            return data;
        } else if (
    ...
    const pageCount = Math.ceil(declines.length / usersPerPage);
            ...
            <div className="col-lg-12 grid-margin stretch-card">
                <div className="card">
                    <div className="card-body">
                        <h4 className="card-title">Decline Products <small>Dashboard</small></h4>
                        {/* <Link
                        ...
                        <button className="action-button badge badge-primary">
                            ...
                            <ExportCSV csvData={declines} fileName={fileName} />
                        </button>
